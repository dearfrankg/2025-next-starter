import type { Todo } from "@/types/todo"; // Importing the Todo type from a types file
...
export const TodoItem: React.FC<TodoItemProps> = ({
  ...
  return (
    <div
      className={
        "flex items-center justify-between px-4 py-2 group" + (hasBorder ? " border-b" : "") // Conditionally adding a border class if hasBorder is true
      }
    >
      <div className="flex items-center">
        ...
        >
          {todo.assignedTo && (
            <span className="mr-2 rounded-md border border-purple-700 bg-purple-400 px-1  py-[2px] text-xs font-medium uppercase text-black">
      ...
      <div className="flex items-center">
        ...
        <button
          ...
          className="ml-2 text-blue-500 opacity-0 transition-opacity duration-200 group-hover:opacity-100"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
